...
from torch.utils.data import DataLoader         # Dataset management and creates mini batches
import torchvision.datasets as datasets         # Standard datasets to import
